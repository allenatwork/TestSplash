...
public class PhotoUtils {
    ...
    public static Bitmap decodeBitmapfromResource(Resources res, int resid, int reqW, int reqH) {
        final BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
    ...
    public static void setResourceforImageView(Resources res, @DrawableRes int resId, ImageView iv) {
        Bitmap bitmap = decodeBitmapfromResource(res, resId, iv.getWidth(), iv.getHeight());
